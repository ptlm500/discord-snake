...
module.exports = class Game {
  ...
  renderGameOver() {
    ...
    s += ':skull::skull::skull::skull::skull::skull::skull::skull::skull::skull:\n\n';
    s += convertStringToDiscordEmojis('Game Over!') + '\n\n';
    s += convertStringToDiscordEmojis(`Score ${this.score}`) + '\n\n';
    s += ':skull::skull::skull::skull::skull::skull::skull::skull::skull::skull:';
    return s;
  }
};
